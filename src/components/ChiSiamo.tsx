    ...
    <section id="chi-siamo" ref={sectionRef} style={{ padding: "100px 24px", position: "relative", overflow: "hidden" }}>
      ...
      <motion.div
        style={{
          ...
          background: "radial-gradient(ellipse, rgba(40,120,180,0.055) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <motion.div
        style={{
          ...
          background: "radial-gradient(ellipse, rgba(40,120,180,0.04) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", position: "relative" }}>
        ...
        <div style={{ marginBottom: 60 }}>
          ...
          <h2 style={{ fontSize: "clamp(32px, 6vw, 56px)", fontWeight: 500, lineHeight: 1.12, letterSpacing: "-0.03em", marginBottom: 16 }}>
          ...
          <motion.p
            ...
            style={{ fontSize: 15, lineHeight: 1.78, color: "var(--text-secondary)", maxWidth: 520 }}
          >
            {t.desc}
          </motion.p>
        </div>
        ...
        >
          <LayoutGroup>
            <div style={{ display: "flex", gap: 4, marginBottom: 32, background: "rgba(255,255,255,0.7)", borderRadius: 12, padding: 4, width: "fit-content", border: "0.5px solid var(--card-border)" }}>
                  ...
                  {tab === i && (
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: 9, background: "var(--blue)",
                        zIndex: -1,
                      }}
          ...
          <AnimatePresence mode="wait">
                    ...
                    {valori.filter(v => v.category === "interno").map((v, i) => (
                      <motion.span
                        ...
                        style={{
                          ...
                          color: "var(--blue-dark)", background: "var(--blue-bg)",
                    ...
                    {valori.filter(v => v.category === "esterno").map((v, i) => (
                      <motion.span
                        ...
                        style={{
                          ...
                          border: "0.5px solid rgba(0,0,0,0.09)", cursor: "default",
                        }}
                      >
                        {v.title[lang]}
                      </motion.span>
            ...
            {tab === 1 && (
              <motion.div
                ...
                transition={{ duration: 0.35, ease }}
              >
                <p style={{ fontSize: 15, lineHeight: 1.78, color: "var(--text-secondary)", marginBottom: 28, maxWidth: 560 }}>
                  {t.styleDesc}
                </p>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 10 }}>
                  {stile.map((s, i) => (
                    ...
                    >
                      <motion.span
                        style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--blue)", flexShrink: 0, display: "block" }}
